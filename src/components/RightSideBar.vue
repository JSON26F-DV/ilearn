<template>
      <aside class="hidden xl:flex xl:flex-col xl:w-72 px-4 py-6 space-y-8 h-880px" id="chat">
      <!-- Profile card -->
      <div v-if="props.showRequest === true" class="bg-gray-50 p-4 rounded-lg shadow-sm">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <h5 class="font-semibold text-gray-800">Tralala</h5>
            <small class="text-sm text-gray-800"><strong>Computer Science, Class of 2026</strong></small>
          </div>
        </div>
        <div class="mt-4 text-gray-600 text-sm leading-snug">
          <small>Welcome back! Here’s your quick overview: 3 new messages, 2 upcoming
          deadlines, and 1 event today.</small>
        </div>
      ...
      <!-- Chat section -->
      <div class="flex-1 flex flex-col bg-white rounded-lg shadow-sm p-4 space-y-4">
        <h4 class="text-lg font-semibold mb-4">Chats</h4>
        <!-- Chat list -->
        <div class="flex-1 overflow-y-auto space-y-3">
          ...
          <div class="flex items-center p-2 rounded-md bg-gray-100 cursor-pointer">
            ...
            <div class="flex-1 text-start">
              ...
              <small class="text-xs text-gray-600 truncate">Sure, let's meet at 2 PM.</small>
            </div>
          </div>
          <!-- Chat item 2 -->
          <div class="flex items-center p-2 rounded-md hover:bg-gray-100 cursor-pointer">
            ...
            <div class="flex-1 text-start">
              ...
              <small class="text-xs text-gray-600 truncate">Don't forget our meeting tomorrow.</small>
            </div>
          </div>
          <!-- Chat item 3 -->
          <div class="flex items-center p-2 rounded-md hover:bg-gray-100 cursor-pointer">
            ...
            <div class="flex-1 text-start">
              ...
              <small class="text-xs text-gray-600 truncate">Thanks for sharing the notes!</small>
            </div>
          </div>
          <!-- Add more chat items as needed -->
        </div>
        <!-- Active chat window -->
        <div v-if="props.showRequest === true" class="mt-4 bg-gray-50 border rounded-md flex flex-col h-64">
